...
Platforma LeftHand 1.1 - zestaw bibliotek, narzędzi i metodologii do
tworzenia właściwych aplikacji, typu aplikacja Firma. Platforma
zapewnia takie elementy jak, na przykład, dostęp do bazy danych,
warstwę komunikacji przez Internet, system użytkowników i ról, czy
